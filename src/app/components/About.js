...
export default function About() {
  return (
    <section className="w-full max-w-5xl mx-auto py-8 md:py-16 px-2 md:px-4 text-center bg-gradient-to-b from-[#0a1817] via-[#0a1817] to-black rounded-xl shadow-lg">
